...
namespace OnlineSurvey.DataAccess.Concrete.EntityFramework.Mappings
{
    public class UserMap : IEntityTypeConfiguration<User>
    {
        public void Configure(EntityTypeBuilder<User> builder)
        {
            ...
            builder.Property(a => a.FirstName).HasColumnName("firstName").HasColumnType("nvarchar(100)");
            builder.Property(a => a.LastName).HasColumnName("lastName").HasColumnType("nvarchar(100)");
